...
export default function Skills() {
    ...
    return (
        <div className='skillBody' >
            <p className='myskills'>My Skills/Tools :</p>
            ...
            <section>
                <div className='allskills'>
                    ...
                    <p><i className="fa-solid fa-t"></i> Tailwind  </p>
                    ...
                    <p><i className="fa-solid fa-c"></i> Canva  </p>
                </div>
                ...
                <div className='allStars'>
                    ...
                    <p className='fiveStars'> = <i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star-half-stroke"></i><i className="fa-regular fa-star"></i><i className="fa-regular fa-star"></i></p>
                    <p className='fiveStars'> = <i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-regular fa-star"></i></p>
                    <p className='fiveStars'> = <i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-regular fa-star"></i></p>
                ...
                <div className='skillRotateBigCont'>
                    <main className='skillRotateCont' loading='lazy'>
                        <h2 className="skillRotateh2 eachSkill1" >Wordpress</h2>
                        <h2 className="skillRotateh2 eachSkill2"  >Html</h2>
                        <h2 className="skillRotateh2 eachSkill3" >Canva</h2>
                        <h2 className="skillRotateh2 eachSkill4" >CSS</h2>
                        <h2 className="skillRotateh2 eachSkill5" >Tailwind</h2>
                        <h2 className="skillRotateh2 eachSkill6" >JS</h2>
                        <h2 className="skillRotateh2 eachSkill7" >Github</h2>
                        <h2 className="skillRotateh2 eachSkill8" >React</h2>
                        <h2 className="skillRotateh2 eachSkill9" >Figma</h2>
                        <h2 className="skillRotateh2 eachSkill10" >Bootstrap</h2>
                    </main>
                </div>
            </section>
        </div>
