        ...
        <div className='skillBody' >
            ...
            <section>
                <div className='allskills'>
                    ...
                    <p><i className="fa-solid fa-e"></i> ExpressJS  </p>
                ...
                <div className='skillRotateBigCont'>
                    <main className='skillRotateCont' loading='lazy'>
                        <h2 className="skillRotateh2 eachSkill1" >MongoDB</h2>
                        <h2 className="skillRotateh2 eachSkill2"  >Html</h2>
                        <h2 className="skillRotateh2 eachSkill3" >Node</h2>
                        <h2 className="skillRotateh2 eachSkill4" >CSS</h2>
                        <h2 className="skillRotateh2 eachSkill5" >Express</h2>
